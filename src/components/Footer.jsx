...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: "https://twitter.com/scholarstream",
    },
    {
      name: "LinkedIn",
      icon: (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          >
            ...
            <p className="text-neutral text-sm mt-4">
              Empowering students to discover and apply for scholarships
              worldwide. Your gateway to educational opportunities.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="flex flex-col"
          >
            <h6 className="footer-title text-primary mb-4 font-bold">
              Quick Links
            </h6>
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  ...
                  className="text-neutral hover:text-primary transition-colors text-sm flex items-center gap-2"
                >
                  <span className="text-primary">›</span> All Scholarships
                </Link>
              </li>
              <li>
                <Link
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-neutral hover:text-primary transition-colors text-sm flex items-start gap-2"
                >
              ...
              <li>
                <div className="text-neutral text-sm flex items-start gap-2">
          ...
          >
            ...
            <p className="text-neutral text-sm mb-4">
              Stay connected with us on social media for the latest scholarship
            ...
            <div className="flex gap-3 flex-wrap">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-10 h-10 rounded-full bg-base-200 flex items-center justify-center text-neutral hover:bg-primary hover:text-primary-content transition-colors"
